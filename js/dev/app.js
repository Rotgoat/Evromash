...
function headerScroll() {
  ...
  let headerShowTimer = header.dataset.flsHeaderScrollShow ? header.dataset.flsHeaderScrollShow : 1e5;
...
function catalogmenu() {
  document.addEventListener("click", function(e) {
    if (bodyLockStatus && e.target.closest("[data-fls-catalogmenu]")) {
      document.documentElement.removeAttribute("data-fls-menu-open");
      document.documentElement.toggleAttribute("data-fls-catalog-open");
      bodyUnlock();
    }
    if (bodyLockStatus && e.target.closest("[data-fls-catalogmenumobile]")) {
      document.documentElement.toggleAttribute("data-fls-catalogmenumobile-open");
      bodyUnlock();
    }
  });
}
document.querySelector("[data-fls-catalogmenu]") ? window.addEventListener("load", catalogmenu) : null;
function spollers() {
...
function initSliders() {
  if (document.querySelector(".swiper.slider-intro")) {
    const contentSlider = new Swiper(".content-slider", {
      modules: [Pagination, Thumb, EffectFade],
      slidesPerView: 1,
      speed: 100,
      watchSlidesProgress: true,
    ...
    new Swiper(".slider-intro", {
      modules: [Pagination, Thumb, Autoplay],
      slidesPerView: 1,
      watchSlidesProgress: true,
      speed: 500,
      loop: true,
  ...
  if (document.querySelector(".swiper.reviewsblock-slider")) {
    new Swiper(".reviewsblock-slider", {
      modules: [Navigation],
      slidesPerView: 1,
      speed: 500,
      spaceBetween: 16,
      navigation: {
        prevEl: ".reviewsblock__nav-btn.--prev",
        nextEl: ".reviewsblock__nav-btn.--next"
      },
      breakpoints: {
        600: {
          slidesPerView: 2.3
  ...
  if (document.querySelector(".swiper.clientlogos-slider")) {
    new Swiper(".clientlogos-slider", {
      modules: [Autoplay],
      slidesPerView: 3,
      speed: 500,
      spaceBetween: 10,
  ...
  if (document.querySelector(".dealers-slider")) {
...
function initGallery() {
  if (document.querySelector("[data-fls-gallery]")) {
    new lightGallery(document.querySelector("[data-fls-gallery].reviewsblock-gallery"), {
      // plugins: [lgZoom],
      licenseKey: KEY,
      selector: "a",
      speed: 500,
